# UAFX_Ruby
## 0.UAFX Buby ってなに？
ストンプBOX形状のアンプシュミレーターであり、VOX AC30 をベースにしている。  
フットスイッチで、ノブの目盛り状態のとおりの音がでる「ライブモード」と、ノブの目盛りに関わらず保存した設定の音が出る「プリセットモード」の２つを切り替えながら使う。  
アンプシュミレーターとしては、3チャンネル分のモデリングがある。
